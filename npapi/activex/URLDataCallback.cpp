...
HRESULT nsURLDataCallback::OpenURL(PluginHostWnd *pOwner, const TCHAR *szURL, void *pNotifyData, const void *pPostData, unsigned long nPostDataSize)
{
...
LRESULT nsURLDataCallback::OnClassCreatePluginInstance(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
{
        ...
        m_pOwner->m_bCreatePluginFromStreamData)
    {
        ...
        if (FAILED(m_pOwner->LoadPlugin(p_data)) ||
