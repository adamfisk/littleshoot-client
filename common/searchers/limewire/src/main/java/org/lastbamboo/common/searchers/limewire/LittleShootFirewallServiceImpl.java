...
@EagerSingleton
public class LittleShootFirewallServiceImpl implements FirewallService, Service {
    
    public static final File EXE_FILE = 
        new File("LittleShoot.exe").getAbsoluteFile();
    
    /** The name of this program, "LittleShoot". */
    private static String name = "LittleShoot";
...
//                return;
    ...
    public boolean isProgrammaticallyConfigurable() {
        ...
        String path = SystemUtils.getRunningPath();
        return path.equalsIgnoreCase(EXE_FILE.getPath());
    }
