...
/Applications/install4j\ 5/bin/install4jc -D "appName=HII,shortName=hii,publisher=Human Interface Initiative,publisherUrl=http://www.hiinterface.org" -m windows -r $APP_VERSION ./LittleShoot.install4j
hiiName=HIIInstaller-$APP_VERSION.exe
mv LittleShootPlugin.exe $hiiName
scp $hiiName afisk@76.168.81.60:/home/afisk/

echo "Uploading $hiiName to Amazon!!"
aws -putp littleshoot $hiiName

echo "Uploaded $hiiName"
