 ...
 * of a request.
 */
public abstract class SignedAbstractCommandController extends HttpServlet {

    private static final long serialVersionUID = 2047542024999143747L;
    ...
    protected void doGet(final HttpServletRequest request, 
        ...
        IOException {
        m_log.trace("Handling signed request: {}", request.getQueryString());
    ...
    protected abstract void handleSigned(
